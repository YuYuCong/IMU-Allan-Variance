...
void imu::AllanGyr::CalculateAllanVariance() {
  std::cout << m_name << " "
...
std::vector<double> imu::AllanGyr::GetVariance() const { return mVariance; }
...
std::vector<double> imu::AllanGyr::GetTimestamp() {
  double period = getAvgPeriod();
...
std::vector<int> imu::AllanGyr::getFactors() const { return mFactors; }
